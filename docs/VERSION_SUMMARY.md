...
**Estado**: Pendiente de revisión · **Comparaciones**: XGBoost y Prophet (benchmark)
...
## 📊 Modelos de comparación (no finales)

| Script | Propósito |
|--------|-----------|
| `run_xgboost.py` | Evaluar XGBoost vs K-Means + RF |
| `run_prophet.py` | Evaluar Prophet vs K-Means + RF |

---

## 📊 COMPARACIÓN DE VERSIONES (Legacy — Regresión)
...
**Estado**: Producción final documentada — pendiente de revisión
