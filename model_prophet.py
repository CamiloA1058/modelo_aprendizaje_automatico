...
for codigo, group in df.groupby('CODIGO'):
    ...
    if processed % 100 == 0:
        ...
        temp_results.to_csv('PREDICCIONES_PROPHET_temp.csv', index=False, encoding='utf-8-sig')
        print(f'[TEMP] Resultados parciales guardados en PREDICCIONES_PROPHET_temp.csv')
...
results.to_csv('PREDICCIONES_PROPHET_intermedio.csv', index=False, encoding='utf-8-sig')
...
results.to_csv('PREDICCIONES_PROPHET.csv', index=False, encoding='utf-8-sig')
print('[OK] Predicciones guardadas en PREDICCIONES_PROPHET.csv')

# Limpiar archivo temporal si existe
if os.path.exists('PREDICCIONES_PROPHET_temp.csv'):
    os.remove('PREDICCIONES_PROPHET_temp.csv')
