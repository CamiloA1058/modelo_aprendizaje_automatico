...
plt.savefig(FIGURES / 'grafico_clusters_v1.0.png')
plt.close()
...
plt.savefig(FIGURES / 'grafico_cluster_summary_v1.0.png')
plt.close()
...
plt.savefig(FIGURES / 'grafico_prediccion_v1.0.png')
plt.close()
...
plt.savefig(FIGURES / 'grafico_importancia_v1.0.png')
plt.close()
