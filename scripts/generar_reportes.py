...
from ventas_forecast.paths import PREDICTIONS, REPORTS, ensure_output_dirs
...
try:
    ...
    df_export.to_csv(PREDICTIONS / 'PREDICCIONES_DETALLADAS.csv', index=False, encoding='utf-8-sig')
    ...
    top_10.to_csv(PREDICTIONS / 'TOP_10_PREDICCIONES.csv', index=False, encoding='utf-8-sig')
...
"""
    ...
    metrics_df.to_csv(PREDICTIONS / 'RESUMEN_METRICAS.csv', index=False, encoding='utf-8-sig')
